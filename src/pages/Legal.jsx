...
export function About() {
  return (
    <div className="max-w-2xl mx-auto py-8">
      <div className="flex items-center gap-2 mb-1"><Info size={20} className="text-emerald-700" /><h1 className="text-2xl font-bold text-slate-900">Rreth ERental</h1></div>
      <p className="text-sm text-slate-500 mb-8">Platforma e pare shqiptare qe lidh biznese te makinave me qera me klientet, ne nje vend te vetem.</p>

      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
        <div className="border border-slate-200 rounded-2xl p-4 text-center">
          <CarIcon size={22} className="mx-auto text-emerald-700 mb-2" />
          <p className="text-sm font-semibold text-slate-900">Krahaso lirisht</p>
          <p className="text-xs text-slate-500 mt-1">Filtro sipas markes, karburantit, cmimit dhe kategorise.</p>
        </div>
        <div className="border border-slate-200 rounded-2xl p-4 text-center">
          <ShieldCheck size={22} className="mx-auto text-emerald-700 mb-2" />
          <p className="text-sm font-semibold text-slate-900">Biznese te verifikuara</p>
          <p className="text-xs text-slate-500 mt-1">Cdo biznes kalon nga verifikimi i NIPT-it para se te listoje makina.</p>
        </div>
        <div className="border border-slate-200 rounded-2xl p-4 text-center">
          <Users size={22} className="mx-auto text-emerald-700 mb-2" />
          <p className="text-sm font-semibold text-slate-900">Pa ndermjetes</p>
          <p className="text-xs text-slate-500 mt-1">Flet direkt me biznesin, rezervo brenda minutash.</p>
        </div>
      </div>
...
export function Contact({ loggedIn, showError }) {
  ...
  return (
    <div className="max-w-md mx-auto py-8">
      <div className="flex items-center gap-2 mb-1"><Mail size={20} className="text-emerald-700" /><h1 className="text-2xl font-bold text-slate-900">Na kontakto</h1></div>
      <p className="text-sm text-slate-500 mb-6">Kemi ndonje pyetje ose problem? Na shkruaj.</p>
      ...
      <div className="flex gap-2 mb-6">
        {loggedIn && (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex-1 flex items-center justify-center gap-2 rounded-xl border border-emerald-300 bg-emerald-50 text-emerald-700 text-sm font-semibold py-2.5 hover:bg-emerald-100 transition"
          >
        ...
        <a
          ...
          className="flex-1 flex items-center justify-center gap-2 rounded-xl border border-slate-200 bg-slate-50 text-slate-700 text-sm font-semibold py-2.5 hover:bg-slate-100 transition"
        >
      ...
      {sent ? (
        <div className="text-center py-10">
          ...
          <p className="text-sm text-slate-600">Mesazhi u dergua. Do te te pergjigjemi shpejt.</p>
        </div>
      ) : (
...
export function Privacy() {
  return (
    <div className="max-w-2xl mx-auto py-8">
      <div className="flex items-center gap-2 mb-1"><Shield size={20} className="text-emerald-700" /><h1 className="text-2xl font-bold text-slate-900">Politika e Privatesise</h1></div>
      <p className="text-xs text-slate-400 mb-6">Perditesuar per here te fundit: Korrik 2026</p>

      <div className="space-y-5 text-sm text-slate-600 leading-relaxed">
        <section>
          <h2 className="font-semibold text-slate-900 mb-1">1. Cfare te dhena mbledhim</h2>
        ...
        <section>
          <h2 className="font-semibold text-slate-900 mb-1">2. Si i perdorim te dhenat</h2>
        ...
        <section>
          <h2 className="font-semibold text-slate-900 mb-1">3. Ruajtja e te dhenave</h2>
        ...
        <section>
          <h2 className="font-semibold text-slate-900 mb-1">4. Te drejtat e tua</h2>
        ...
        <section>
          <h2 className="font-semibold text-slate-900 mb-1">5. Kontakt</h2>
          <p>Per pyetje rreth privatesise, na kontakto ne <a href={`mailto:${SUPPORT_EMAIL}`} className="text-emerald-700 underline">{SUPPORT_EMAIL}</a></p>
        </section>
      </div>
    </div>
  );
...
export function Terms() {
  return (
    <div className="max-w-2xl mx-auto py-8">
      <div className="flex items-center gap-2 mb-1"><FileText size={20} className="text-emerald-700" /><h1 className="text-2xl font-bold text-slate-900">Kushtet e Perdorimit</h1></div>
      <p className="text-xs text-slate-400 mb-6">Perditesuar per here te fundit: Korrik 2026</p>

      <div className="space-y-5 text-sm text-slate-600 leading-relaxed">
        <section className="bg-emerald-50 border border-emerald-200 rounded-xl p-4">
          <h2 className="font-semibold text-slate-900 mb-1">ERental eshte nje marketplace (platforme ndermjetese)</h2>
        ...
        <section>
          <h2 className="font-semibold text-slate-900 mb-1">1. Roli i ERental</h2>
        ...
        <section>
          <h2 className="font-semibold text-slate-900 mb-1">2. Verifikimi i bizneseve</h2>
        ...
        <section>
          <h2 className="font-semibold text-slate-900 mb-1">3. Pergjegjesia e klientit dhe biznesit</h2>
        ...
        <section>
          <h2 className="font-semibold text-slate-900 mb-1">4. Anulimet</h2>
        ...
        <section>
          <h2 className="font-semibold text-slate-900 mb-1">5. Ndryshime</h2>
...
export function Careers({ showError }) {
  ...
  if (sent) {
    return (
      <div className="max-w-md mx-auto py-16 text-center">
        ...
        <h1 className="text-xl font-bold text-slate-900">Faleminderit!</h1>
        <p className="text-sm text-slate-500 mt-2">Aplikimi yt u dergua. Do te te kontaktojme nese ka pershtatje.</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-md mx-auto py-8">
      <div className="flex items-center gap-2 mb-1"><Briefcase size={20} className="text-emerald-700" /><h1 className="text-2xl font-bold text-slate-900">Karriere</h1></div>
      <p className="text-sm text-slate-500 mb-2">Ne rritje jemi — nese do te doje te bashkohesh me ekipin e ERental, na trego pak per veten.</p>
      <a href={`mailto:${SUPPORT_EMAIL}`} className="text-xs text-emerald-700 underline">{SUPPORT_EMAIL}</a>
